...
3. `ai/summary.md` describes the project as it stands: start there. New prompts and plans go in `ai/`, numbered and paired from `prompt_0.md` (prompt_0.md -> plan_0.md -> next_0.md -> feedback_0.md). Write a new plan next to the prompt it answers.
- next_0.md is a summary of the implementation and what to work on next as decided by Claude.
- feedback_0.md is a list of human feedbacks on the implementation and current state of the project.
